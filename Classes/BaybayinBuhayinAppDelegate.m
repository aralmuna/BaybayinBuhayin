...
@implementation BaybayinBuhayinAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
    ...
    BaybayinHomeViewController *homeViewController = [[BaybayinHomeViewController alloc] initWithNibName:@"BaybayinHomeViewController" bundle:nil];
